...
@ConditionalOnProperty(value = "mosip.esignet.integration.authenticator", havingValue = "SunbirdAuthenticationService")
@Component
@Slf4j
public class SunbirdAuthenticationService implements Authenticator {
    ...
    public KycAuthResult doKycAuth(@NotBlank String relyingPartyId, @NotBlank String clientId,
        ...
        return authenticationHelperService.doKycAuthImpl(relyingPartyId, clientId, kycAuthDto);
    }
    ...
    public KycExchangeResult doKycExchange(String relyingPartyId, String clientId, KycExchangeDto kycExchangeDto)
        ...
        try {
            ...
            kycExchangeRequestDto.setRequestDateTime(AuthenticationHelperService.getUTCDateTime());
    ...
    public boolean isSupportedOtpChannel(String channel) {
        return authenticationHelperService.isSupportedOtpChannel(channel);
    }
